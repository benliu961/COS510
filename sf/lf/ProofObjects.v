...
Definition conj_fact : forall P Q R, P /\ Q -> Q /\ R -> P /\ R :=
  fun P Q R HPQ HQR => match HPQ with
...
Definition de_morgan_not_or : forall P Q : Prop,
    ~ (P \/ Q) -> ~P /\ ~Q :=
  fun P Q H => conj (fun HP => H (or_introl HP)) (fun HQ => H (or_intror HQ)).
(** [] *)
...
Proof. 
  intros. unfold proof_irrelevance. intros. 
  assert (H1: True = P). { apply pe_implies_true_eq. apply H. apply pf1. } 
  destruct H1. destruct pf1. destruct pf2. reflexivity. Qed.
(** [] *)
