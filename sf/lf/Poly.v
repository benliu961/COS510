...
Proof.
  ...
  induction l.
  - reflexivity.
  - simpl. rewrite <- IHl. rewrite app_map. reflexivity. Qed.
(** [] *)
...
*)
(*  Theorem: forall X l n, if length l = n, then @nth_error X l n = None 
    ...
    - Next, suppose [n = S n'], l = a :: l' forall a : X, and length l' = n' where
      ...
      We want to show that nth_error X l n = None
    
        Therefore, we have nth_error X l n = nth_error X l' n'. The result follows 
        immediately from the induction hypothesis. _Qed_.
      *)
